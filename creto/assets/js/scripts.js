...
"use strict";
    ...
    $(document).ready(function() {
        ...
        $('.slider-single-for .slide-single-for:not(:first)').hide();

        $('.frame-size ul li').click(function() {
            // Remove active class from all li elements
            $('.frame-size ul li').removeClass('active');
            ...
            // Set the value of the input text with name "color"
            var color = $(this).text().trim();
            $('input[name="color"]').val(color);

            // Hide all images
            $('.slider-single-for .slide-single-for').hide();

            // Show the image corresponding to the clicked color
            $('.slider-single-for .slide-single-for').eq(index).show();
        });
    });
	...
	const wilayas = {
		"Algiers": ["Alger", "Bab Ezzouar", "Baraki", "Bir Mourad Raïs", "Birkhadem", "Bir Mourad Raïs", "Birtouta", "Bordj El Bahri", "Bourouba", "Dar El Beïda", "Dely Ibrahim", "Djasr Kasentina", "Douera", "Draria", "El Achour", "H'raoua", "Hussein Dey", "Khemis El Khechna", "Kouba", "Mahelma", "Mohammadia", "Rahmania", "Reghaïa", "Rouïba", "Saoula", "Souidania", "Staoueli", "Tessala El Merdja", "Zéralda"],
		"Oran": ["Oran", "Aïn El Türck", "Bir El Djir", "Es-Sénia", "Gdyel", "Oran", "Boufatis", "Hassi Bounif", "Messerghin", "Aïn Kerma", "Aïn Turk", "Arzew", "Béthioua", "Bousfer", "Marsat El Hadjadj", "Mers El Hadjadj", "Mers El Kébir", "Sidi Ben Yabka", "Sidi Chami", "Tafraoui"],
		// Add more wilayas and their communes as needed
	};
	...
	wilayaSelect.addEventListener('change', function() {
		...
		if (selectedWilaya) {
			...
			// Populate commune select based on selected wilaya
			...
			// Show the commune form
			communeForm.style.display = 'block';
		} else {
			// Hide the commune form if no wilaya is selected
			communeForm.style.display = 'none';
		}
	});
